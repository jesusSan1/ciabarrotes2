...
// Para poner el nombre del modulo
let contenido = window.location.pathname.split("/")[1];
let titulo = document.querySelector("#titulo");
switch (contenido) {
  case "dashboard":
    titulo.innerHTML = "Menú principal";
    break;
  case "configuracion":
    titulo.innerHTML = "Configuración";
    break;
  case "empleados":
    titulo.innerHTML = "Empleados";
    break;
  case "editar-empleado":
    titulo.innerHTML = "Editar empleado";
    break;
  case "perfil":
    titulo.innerHTML = "Actualizar perfil";
    break;
  case "categorias":
    titulo.innerHTML = "Categorias";
    break;
  case "bitacora":
    titulo.innerHTML = "Bitacora";
    break;
  case "proveedores":
    titulo.innerHTML = "Proveedores";
    break;
  case "editar-proveedor":
    titulo.innerHTML = "Editar proveedor";
    break;
}
...
//* Controlar los menus con el hash
document.addEventListener("DOMContentLoaded", () => {
  if (window.location.hash) {
    const hash = window.location.hash.substring(1);
    switch (hash) {
      case "lista-categorias":
        borrarHash(".lista-categorias");
        break;
      case "lista-empleados":
        borrarHash(".lista-empleados");
        break;
      case "lista-proveedores":
        borrarHash(".lista-proveedores");
        break;
      case "producto-almacen":
        borrarHash(".producto-almacen");
        break;
      case "producto-minimo":
        borrarHash(".producto-minimo");
        break;
      case "producto-caducado":
        borrarHash(".producto-caducado");
        break;
    }
  }
});

function borrarHash(el) {
